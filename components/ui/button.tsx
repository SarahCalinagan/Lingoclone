  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        secondary:"bg-sky-600 text-primary-foreground hover:bg-sky-700/90 border-sky-700 border-b-4 active:border-b-0",
        secondaryOutline: "bg-white text-sky-700 hover:bg-slate-100",
        third:"bg-green-600 text-primary-foreground hover:bg-green-700/90 border-green-700 border-b-4 active:border-b-0",
        thirdOutline: "bg-white text-green-700 hover:bg-slate-100",
        ...
        sidebar: "bg-transparent text-slate-500 border-2 border-transparent hover:bg-slate100 transition-none",
