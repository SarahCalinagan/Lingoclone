...
import { Trees, Sprout, Flower2, Droplet } from "lucide-react";
...
export const LessonButton = ({
    ...
    const Icon = isCompleted ? Trees : isLast ? Flower2 : Sprout;
            ...
            <div className="relative"
                ...
                {current ?(
                    <div className="h-[102px] w-[102px] relative">
                        <div className="absolute -top-6 left-2.5 px-3 py-2.5 border-2 font-bold uppercase text-blue-700 bg-white rounded-xl animate-bounce tracking-wide z-10">
