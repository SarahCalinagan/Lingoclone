...
import { QuestionBubble } from "./quesbubble";
import { Challenge } from "./challenge";
import { Footer } from "./footer";
import { upsertChallengeProgress } from "@/actions/challengeprog";
import { toast } from "sonner";
import { reduceHearts } from "@/actions/user-progress";
import { useAudio, useWindowSize, useMount } from "react-use";
import Image from "next/image";
import { RersultCard } from "./resultcard";
...
type Props ={
    ...
    userSubscripton: typeof userSubscription.$inferSelect & {
        isActive: boolean;
    } | null ;
};
...
export const Quiz = ({
    ...
    const[selectOption, setSelectedOption] = useState<number>();
    ...
    const onContinue = () => {
        ...
        if (correctOption.id === selectOption) {
            startTransition(() => {
                ...
                .catch(() => toast.error("Something was wrong. please try again"))
            });
        } else {
            startTransition(() => {
            ...
            <>
                ...
                <div className="flex flex-col gap-y-4 lg:gap-y-8 max-w-lg mx-auto text-center items-center justify-center h-full">
                    ...
                    <h1 className="text-lg lg:text-3xl font-bold text-neutral-700">
                        Great Job! <br /> You have completed a Lesson.
                    </h1>
